import{a as we}from"./index-B-lxVbXh.js";import{d as $e,v as _e,x as Ve,m as xe,y as He,o as h,f as v,u as B,j as Le,g as y}from"./vue.esm-bundler-B7hVH_fS.js";import{I as z}from"./Icon-BHk58rUJ.js";import{_ as De}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./v4-CtRu48qb.js";const Fe=$e({inheritAttrs:!1,components:{Icon:z},props:{skin:{type:String,default:"primary"},size:{type:String,default:"m"},disabled:{type:Boolean,default:void 0},enhanced:{type:Boolean,default:!1},tag:{type:String,default:"button"}}}),Pe={key:0,class:"icon-wrap is-left"},Ce={class:"body"},Ee={key:1,class:"icon-wrap is-right"};function Me(e,Ne,Xe,Re,Te,je){return h(),_e(He(e.tag),xe(e.$attrs,{class:[[`skin-${e.skin}`,`size-${e.size}`,e.enhanced&&"is-enhanced"],"flat-button"],disabled:e.disabled||void 0}),{default:Ve(()=>[e.$slots.leftIcon?(h(),v("div",Pe,[y(e.$slots,"leftIcon",{},void 0,!0)])):B("",!0),Le("div",Ce,[y(e.$slots,"default",{},void 0,!0)]),e.$slots.rightIcon?(h(),v("div",Ee,[y(e.$slots,"rightIcon",{},void 0,!0)])):B("",!0)]),_:3},16,["class","disabled"])}const S=De(Fe,[["render",Me],["__scopeId","data-v-ef3a5852"]]);Fe.__docgenInfo={exportName:"default",displayName:"FlatButton",description:"",tags:{},props:[{name:"skin",values:["important","primary","primary-line","secondary","tertiary","muted","disabled"],type:{name:"string"},defaultValue:{func:!1,value:"'primary'"}},{name:"size",values:["xl","l","m","s","xs"],type:{name:"string"},defaultValue:{func:!1,value:"'m'"}},{name:"disabled",type:{name:"boolean"},defaultValue:{func:!1,value:"undefined"}},{name:"enhanced",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"tag",type:{name:"string"},defaultValue:{func:!1,value:"'button'"}}],slots:[{name:"leftIcon"},{name:"default"},{name:"rightIcon"}],sourceFiles:["/home/runner/work/lapras-frontend/lapras-frontend/src/components/FlatButton/FlatButton.vue"]};const Ke={title:"FlatButton",component:S,render:e=>({components:{FlatButton:S,Icon:z},setup(){return{args:e,action:we("clicked")}},template:`
      <FlatButton
        @click="action"
        :skin="args.skin"
        :size="args.size"
...
}`,...(X=(N=t.parameters)==null?void 0:N.docs)==null?void 0:X.source}}};var R,T,j;o.parameters={...o.parameters,docs:{...(R=o.parameters)==null?void 0:R.docs,source:{originalSource:`{
  name: 'skin: tertiary',
  args: {
    label: 'label',
    skin: 'tertiary'
  }
}`,...(j=(T=o.parameters)==null?void 0:T.docs)==null?void 0:j.source}}};var A,O,q;l.parameters={...l.parameters,docs:{...(A=l.parameters)==null?void 0:A.docs,source:{originalSource:`{
  name: 'skin: muted',
  args: {
    label: 'label',
    skin: 'muted'
  }
}`,...(q=(O=l.parameters)==null?void 0:O.docs)==null?void 0:q.source}}};var G,J,K;i.parameters={...i.parameters,docs:{...(G=i.parameters)==null?void 0:G.docs,source:{originalSource:`{
  name: 'skin: disabled',
  args: {
    label: 'label',
    skin: 'disabled'
