import{d as y,o as T,f as k,k as r,g as i,p as L,r as $}from"./vue.esm-bundler-CXKGtDvb.js";import{_ as V}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{C as o}from"./CheckBox-Brmx__a7.js";import{T as _}from"./ToggleSwitch-BQwUveFg.js";import"./Icon-DvnrdZbN.js";const h=y({props:{isActive:{type:Boolean,default:!1},isButton:{type:Boolean,default:!1},disabled:{type:Boolean,default:!1},isFlipped:{type:Boolean,default:!1}}}),w={class:"toggle"},A={class:"label"};function D(e,n,x,N,E,I){return T(),k("label",{class:L(["toggle-label-set",{"is-active":e.isActive,"is-button":e.isButton,"is-disabled":e.disabled,"is-flipped":e.isFlipped}])},[r("div",w,[i(e.$slots,"toggle",{},void 0,!0)]),r("div",A,[i(e.$slots,"default",{},void 0,!0)])],2)}const d=V(h,[["render",D],["__scopeId","data-v-29bfced2"]]);h.__docgenInfo={exportName:"default",displayName:"ToggleLabelSet",description:"",tags:{},props:[{name:"isActive",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"isButton",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"disabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"isFlipped",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}}],slots:[{name:"toggle"},{name:"default"}],sourceFiles:["/Users/kawamataryou/ghq/github.com/lapras-inc/lapras-frontend/src/components/ToggleLabelSet/ToggleLabelSet.vue"]};const G={title:"ToggleLabelSet",component:d,render:e=>({components:{ToggleLabelSet:d,CheckBox:o,ToggleSwitch:_},setup(){const n=$(e.value);return{args:e,value:n}},template:`
...
}`,...(m=(u=a.parameters)==null?void 0:u.docs)==null?void 0:m.source}}};var c,f,g;l.parameters={...l.parameters,docs:{...(c=l.parameters)==null?void 0:c.docs,source:{originalSource:`{
  name: 'disabled',
  args: {
    value: true,
    label: 'label',
...
}`,...(g=(f=l.parameters)==null?void 0:f.docs)==null?void 0:g.source}}};var b,v,B;s.parameters={...s.parameters,docs:{...(b=s.parameters)==null?void 0:b.docs,source:{originalSource:`{
  name: 'flipped',
  args: {
    value: true,
    label: 'label',
...
}`,...(S=(F=t.parameters)==null?void 0:F.docs)==null?void 0:S.source}}};const H=["Default","Disabled","Flipped","Button"];export{t as Button,a as Default,l as Disabled,s as Flipped,H as __namedExportsOrder,G as default};
