import{d as h,o as s,f as n,g as c,x as y,k as _,p as I,m as $}from"./vue.esm-bundler-DZRSKMuI.js";import{_ as E}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{I as A}from"./Icon-DBiXbAZg.js";const T=h({inheritAttrs:!1,props:{background:{type:String,default:"#EAEAEA"},color:{type:String,default:"#7F7F7F"}}}),F={key:0,class:"sub"};function B(e,P,H,N,V,C){return s(),n("div",$(e.$attrs,{style:{background:e.background,color:e.color},class:"tag-label"}),[e.$slots.subLabel?(s(),n("p",F,[c(e.$slots,"subLabel",{},void 0,!0)])):y("",!0),_("p",{class:I(["main",{"has-sub-label":e.$slots.subLabel}])},[c(e.$slots,"default",{},void 0,!0)],2)],16)}const a=E(T,[["render",B],["__scopeId","data-v-b80e4e79"]]);T.__docgenInfo={exportName:"default",displayName:"TagLabel",description:"",tags:{},props:[{name:"background",type:{name:"string"},defaultValue:{func:!1,value:"'#EAEAEA'"}},{name:"color",type:{name:"string"},defaultValue:{func:!1,value:"'#7F7F7F'"}}],slots:[{name:"subLabel"},{name:"default"}],sourceFiles:["/home/runner/work/lapras-frontend/lapras-frontend/src/components/TagLabel/TagLabel.vue"]};const z={title:"TagLabel",component:a},r={name:"default",args:{defaultSlot:"label",background:void 0,color:void 0},render:e=>({components:{TagLabel:a},setup(){return{args:e}},template:`
    ...
    `})},t={name:"has icon",args:{defaultSlot:"Python",background:void 0,color:void 0,level:"5",icon:"eye-close"},render:e=>({components:{TagLabel:a,Icon:A},setup(){return{args:e}},template:`
      <TagLabel :background="args.background" :color="args.color" :level="args.level">
        <template #subLabel>
          <Icon :name="args.icon" />
        </template>
...
}`,...(S=(v=t.parameters)==null?void 0:v.docs)==null?void 0:S.source}}};const j=["Default","Background","HasLevel","HasIcon"];export{o as Background,r as Default,t as HasIcon,l as HasLevel,j as __namedExportsOrder,z as default};
