import{d as z,e as u,o as G,f as K,g as M,m as Q}from"./vue.esm-bundler-CXKGtDvb.js";import{_ as Y}from"./_plugin-vue_export-helper-DlAUqK2U.js";const h=e=>{if(e&&!(e.includes(":")&&!e.match(/^https?:\/\//i)))return e},U=z({inheritAttrs:!1,props:{href:{type:String,validator(e){return!!h(e)}},force:{type:Boolean,default:!1},target:{type:String},rel:{type:String}},setup(e){const d=u(()=>e.force?e.href:h(e.href)),i=u(()=>e.target==="_blank"?`noopener ${e.rel||""}`.replace(/\s$/,""):e.rel);return{escapedHref:d,formattedRel:i}}}),Z=["href","rel","target"];function ee(e,d,i,ae,re,te){return G(),K("a",Q(e.$attrs,{href:e.escapedHref,rel:e.formattedRel,target:e.target}),[M(e.$slots,"default")],16,Z)}const f=Y(U,[["render",ee]]);U.__docgenInfo={exportName:"default",displayName:"ProtectedLink",description:"",tags:{},props:[{name:"href",type:{name:"string"}},{name:"force",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"target",type:{name:"string"}},{name:"rel",type:{name:"string"}}],slots:[{name:"default"}],sourceFiles:["/Users/kawamataryou/ghq/github.com/lapras-inc/lapras-frontend/src/components/ProtectedLink/ProtectedLink.vue"]};const oe={title:"ProtectedLink",component:f,render:e=>({components:{ProtectedLink:f},setup(){return{args:e}},template:'<ProtectedLink v-bind="args">{{ args.default }}</ProtectedLink>'})},a={name:"default",args:{href:"//placehold.jp/150x150.png",default:"//placehold.jp/150x150.png"}},r={name:"http",args:{href:"http://placehold.jp/150x150.png",default:"http://placehold.jp/150x150.png"}},t={name:"https",args:{href:"https://placehold.jp/150x150.png",default:"https://placehold.jp/150x150.png"}},n={name:"absolute path",args:{href:"/example",default:"/example"}},s={name:"relative path1",args:{href:"./example",default:"./example"}},o={name:"relative path2",args:{href:"example",default:"example"}},p={name:"valid attrs inherited",args:{href:"https://placehold.jp/150x150.png",default:"https://placehold.jp/150x150.png"}},l={name:"xss javascript scheme",args:{href:"javascript:alert(document.domain)",default:"javascript:alert(document.domain)"}},c={name:"target=_blank",args:{href:"https://en.wikipedia.org/wiki/William_Shakespeare",target:"_blank",rel:"author",default:"author of Hamlet"}},m={name:"force permit any link",args:{href:"javascript:alert(document.domain)",force:!0,default:"javascript:alert(document.domain)"}};var g,x,v;a.parameters={...a.parameters,docs:{...(g=a.parameters)==null?void 0:g.docs,source:{originalSource:`{
  name: 'default',
  args: {
...
}`,...(W=(T=c.parameters)==null?void 0:T.docs)==null?void 0:W.source}}};var q,C,O;m.parameters={...m.parameters,docs:{...(q=m.parameters)==null?void 0:q.docs,source:{originalSource:`{
